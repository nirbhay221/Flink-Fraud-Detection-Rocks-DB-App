...
public class FraudDetectionJob {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<Tuple2<Long, Double>> keyedTransactions1 = transactions1
				...
				.name("keyed-transactions-1").setParallelism(2);
		CustomTumblingWindow customTumblingWindow = new CustomTumblingWindow(5000,100,0);
		...
		DataStream<Tuple2<Long, Double>> aggregatedTransactions1 = keyedTransactions1
				.keyBy(0)
				.window(new CustomTumblingWindow(3000, 100, 0))
