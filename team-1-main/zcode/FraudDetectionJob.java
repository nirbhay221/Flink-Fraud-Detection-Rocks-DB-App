...
public class FraudDetectionJob {
	...
	public static void main(String[] args) throws Exception {
		...
		config.setLong("restart-strategy.fixed-delay.attempts", 3);
		config.setLong("restart-strategy.fixed-delay.delay", 10000); // 10 seconds
		...
		DataStream<Tuple2<Long, Double>> aggregatedTransactions1 = keyedTransactions1
				.keyBy(0)
				.window(new CustomTumblingWindow(3000, 1000000, 0))
				.trigger(new CustomTumblingTrigger(3000, 0))
