...
import static utils.AppBase.pathToRocksDBCheckpoint;
...
public class FraudDetectionJob {
	...
	public static void main(String[] args) throws Exception {
		...
		RocksDBStateBackend rocksDBStateBackend = new RocksDBStateBackend(pathToRocksDBCheckpoint);
		...
		DataStream<Transaction> transactions1 = env
				...
				.assignTimestampsAndWatermarks(
					...
					System.out.println("Transaction: " + transaction.getTimestamp() + " - " + transaction.getAccountId());
					return transaction;
				});
