...
public class FraudDetectionJob {
	...
	public static void main(String[] args) throws Exception {
		...
		// Get a Flink execution environment
		StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();

		// Set a checkpoint interval of 5 seconds
		long checkpointInterval = 5000;
		env.enableCheckpointing(checkpointInterval);

		// Set up a RocksDB state backend to store state snapshots
		RocksDBStateBackend rocksDBStateBackend = new RocksDBStateBackend("file:///home/user/Desktop/Stream-CS551/project/frauddetection3/rocksdb_data");
