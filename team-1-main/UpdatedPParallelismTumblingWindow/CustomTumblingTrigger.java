...
import java.util.List;public class CustomTumblingTrigger extends Trigger<Tuple3<Long, Double, Long>, TimeWindow> {
    ...
    public TriggerResult onElement(Tuple3<Long, Double, Long> element, long timestamp, TimeWindow window, TriggerContext ctx) throws Exception {
        ...
        // Store the account id of the last processed element
        lastAccountId = element.f0;
    ...
    public TriggerResult onEventTime(long time, TimeWindow window, TriggerContext ctx) throws Exception {
        ...
        if (ctx.getCurrentWatermark() >= window.getEnd()) {
            keyGroup = (int) (lastAccountId % 2); // Assuming parallelism of 2
